                    ...
                    <div class="flex flex-col p-8 gap-6">
                        ...
                        <div class="flex flex-col rounded-3xl border border-patungan-border p-4 gap-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-semibold text-lg leading-[22px] text-patungan-grey">/person</span>
                                </p>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <p class="font-medium text-lg leading-[22px] text-patungan-grey">Garansi Uang Kembali~</p>
                            </div>
                        </div>
