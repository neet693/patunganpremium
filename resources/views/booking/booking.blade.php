        ...
        <div class="flex gap-9 mb-20">
            ...
            <form method="POST" action="{{ route('front.booking_store', $product->slug) }}"
                ...
                <div class="flex h-[119px] px-6 pt-8 pb-16 bg-[#007B9D] -mb-8">
                    <p class="w-full text-center font-bold text-lg leading-[22px] text-white">Please enter data
                        correctly! We will send the order receipts to your email</p>
                </div>
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex flex-col rounded-3xl border border-patungan-border p-6 gap-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <p class="font-bold text-xl leading-[25px]">
                                    Rp{{ number_format($product->price_per_person, 0, ',', '.') }}</p>
                            </div>
                            <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <p class="font-bold text-xl leading-[25px]">
                                    Rp{{ number_format($totalTaxAmount, 0, ',', '.') }}</p>
                            </div>
                            <hr class="border-patungan-border">
                            <div class="flex items-center justify-between">
